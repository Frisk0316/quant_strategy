...
| G-006 | E-057 H-010 distinctness contract is structurally impossible | Candidate window `[2020-01-01, 2020-04-01)` (91 days); gating references declared from 2024-01-01 and 2022-05-12; `MIN_COMMON_DAYS=365` | Explicit contract-defect refusal before DB connection, probe execution, or artifact write; each reference reports 0 achievable common days and immutable E-057 remains unchanged | I49 | `tests/unit/test_xvenue_leadlag_probe.py::test_distinctness_feasibility_rejects_e057_contract`, `tests/unit/test_pipeline_stage2_registry.py::test_run_data_probe_refuses_e057_distinctness_before_connect_or_artifact` |
| G-007 | H-023 PIT low-idiosyncratic-volatility ranking and execution lag | Synthetic BTC plus two low- and two high-residual-vol assets, one ineligible BTC clone, Monday decision, zero funding | BTC and the ineligible clone have zero target; low-residual names are long and high-residual names short; Monday closed-bar information first appears in Tuesday's executable target and positions remain zero until the following bar; missing paired covariance is not ranked | I8, I20, I23 | `tests/unit/test_xs_idiovol_backtest.py` |

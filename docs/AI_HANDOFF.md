...
13. **MA/MACD research baseline doc gap** (P1 docs-only): MA/EMA/MACD are now intended as long/flat research-validation baselines, but `research/strategy_synthesis.md` has not yet been updated. Claude should add a docs-only baseline section stating the non-live-ready purpose, execution assumptions, and OOS/WF/CPCV acceptance gates.
...
6. **[P1]** Claude docs-only update: add MA/EMA/MACD long-flat baseline section to `research/strategy_synthesis.md`.

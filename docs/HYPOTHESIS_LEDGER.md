...
| H-010 | F-XVENUE-LEADLAG | 0 | A Binance/OKX lead-lag hypothesis can be specified only if venue-scoped canonical 1m candles exist for both legs over the same window without cross-venue substitution. | `results/idea_batch_20260701_taxonomy_002/idea_batch.json`; `docs/superpowers/specs/2026-06-30-mechanism-taxonomy.md`; I19 | proposed | E-029 | Proposed placeholder only. E-029 is a Stage-2 data-availability probe, not a strategy verdict or promotion artifact. |

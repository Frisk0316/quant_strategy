...
| H-012 | F-OI-POSITIONING | 0 | An open-interest positioning hypothesis can be specified only if Binance Vision historical 5m BTC/ETH OI observations cover the probe window with low missing/stale ratios. | `results/idea_batch_20260701_taxonomy_002/idea_batch.json`; `docs/superpowers/specs/2026-06-30-mechanism-taxonomy.md`; `results/stage2_probe_20260704_oi/idea_batch_20260701_taxonomy_002/f_oi_positioning/stage2_feasibility.json` | proposed | E-034 | Proposed placeholder only. E-034 data availability PASSES: both `oi_binance_hist_btc` and `oi_binance_hist_eth` have 258,493 / 258,624 expected 5m rows from 2024-01-01 through 2026-06-16 UTC, coverage 0.999493, missing_ratio 0.000507, stale_ratio 0.004454. This unlocks Claude Stage-1 spec drafting; it is not a strategy verdict, WF/CPCV evidence, or promotion artifact. |

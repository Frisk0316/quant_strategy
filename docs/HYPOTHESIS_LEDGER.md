...
| H-012 | F-OI-POSITIONING | 0 | A daily-rebalanced time-series book over the OI-good PIT USDT-perp universe that fades L-day price moves occurring on falling contract-count open interest earns positive net-of-cost Sharpe surviving WF/CPCV with DSR >= 0.95 and PSR >= 0.95. | `results/idea_batch_20260701_taxonomy_002/idea_batch.json`; `docs/superpowers/specs/2026-06-30-mechanism-taxonomy.md`; `results/stage2_probe_20260704_oi/idea_batch_20260701_taxonomy_002/f_oi_positioning/stage2_feasibility.json`; `docs/superpowers/specs/2026-07-04-f-oi-positioning-hypothesis.md`; `results/stage2_probe_20260705_oi_universe/idea_batch_20260701_taxonomy_002/f_oi_positioning/stage2_feasibility.json` | proposed | E-034; E-036 | Stage-1 spec drafted and user-signed-off 2026-07-04: divergence-fade TS book on falling contract-count OI, pre-registered 4-combo grid, and distinctness checker vs F-FUNDING-XS-DISPERSION required at Stage-3 preflight. E-034 BTC/ETH seed data availability passed. E-036 completed the user-directed universe-wide Binance Vision OI backfill plus PIT-aware data probe: 31 OI-good symbols pass the `>=10` breadth gate; `SHIB-USDT-SWAP` fails because native `SHIBUSDT` metrics zips are absent, while `1000SHIB-USDT-SWAP` passes as its own native market. This unlocks Task B Stage-3 preflight/build, but is not a strategy verdict, WF/CPCV evidence, checkpoint evidence, or promotion artifact. |

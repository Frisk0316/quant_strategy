...
| H-009 | F-FUNDING-XS-DISPERSION | 0 | A cross-sectional funding-dispersion book over a point-in-time liquid USDT-perp universe has enough 8H funding breadth to justify Claude Stage-1 specification before any WF/CPCV search. | `results/idea_batch_20260701_taxonomy_002/idea_batch.json`; `docs/superpowers/specs/2026-06-30-mechanism-taxonomy.md` | proposed | E-028 | Proposed placeholder only. E-028 is a Stage-2 data-availability probe, not a strategy verdict or promotion artifact. |

...
| H-008 | F-SENTIMENT | 0 | A BTC long/flat book that goes long on Extreme Fear and holds through Fear/Neutral, exiting only on Greed or Extreme Greed, earns a positive net-of-cost Sharpe beating BTC buy-hold, surviving WF/CPCV with DSR >= 0.95 and PSR >= 0.95. | `research/strategy_synthesis.md` Strategy 9; `docs/superpowers/specs/2026-06-29-c3-sentiment-hypothesis.md` | proposed | E-019 (planned); E-020 (blocked attempt); E-023 | **DATA-BLOCKED / UNTESTED — not refuted, not inconclusive-from-evidence.** Pipeline batch 2 C3 Stage-2 FAIL: `external_observations.dataset_id='fear_greed_btc'` has event_count 0 over 2024-01-01 through 2026-06-17, so the External-Feature Coverage Gate could not pass; no grid trials ran (family n_trials stays 0) and no proxy was fabricated. The hypothesis was **never tested**, so status stays `proposed`. To unblock: ingest the Alternative.me Fear & Greed history (free public API, daily, single series) into `external_observations`, then run C3; otherwise park as data-blocked. |

...
| F-FUNDING-XS-DISPERSION | 橫斷 funding 排序(做多低/做空高 funding 永續) | funding 當全 universe 的擁擠/持倉溢酬 | **available-pending-universe-fix**(2026-07-03 回補後 22 universe 標的 8H funding 0 缺口;warmup 窗緣已依使用者批准修正[manifest `2026-07-03-stage2-breadth-warmup.md`],DB-universe 診斷已 `data_availability=PASS`[good 28/10、min 24/10];只剩 P9 membership 重建) | frontier-unvetted | ⚠ F-FUNDING-CARRY(**須證明與單名 carry 機制不同**,否則歸 F-FUNDING-CARRY) | 高 |

...
| F-FUNDING-XS-DISPERSION | 橫斷 funding 排序(做多低/做空高 funding 永續) | funding 當全 universe 的擁擠/持倉溢酬 | **available — Stage-2 data_availability PASS**(E-030,2026-07-04:P9 membership 重建[改吃 DB,eligible/day 中位數 2→28]+ warmup 窗緣修正後,32 標的、good 28/10、min breadth 24/10、median 27。`stage2_status` 仍 FAIL,待 distinctness/cost_after_edge) | frontier-unvetted | ⚠ F-FUNDING-CARRY(**須證明與單名 carry 機制不同**,否則歸 F-FUNDING-CARRY — 完整機制論證見 `docs/superpowers/specs/2026-07-04-f-funding-xs-dispersion-hypothesis.md`) | 高 |
